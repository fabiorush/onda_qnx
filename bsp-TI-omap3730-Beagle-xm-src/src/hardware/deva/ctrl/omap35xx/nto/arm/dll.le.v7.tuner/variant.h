...
#define OMAP35XX_TX_VOICES  		0
#define OMAP35XX_RX_VOICES  		2
#define OMAP35XX_CLK_MODE			MASTER

__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/trunk/hardware/deva/ctrl/omap35xx/nto/arm/dll.le.tuner/variant.h $ $Rev: 240415 $" )
