...
#define DISP_SURFACE_UMA_MEM				0x00800000	/* surface is allocated by UMA GPU */
...
typedef struct disp_surface {
	...
	unsigned char	*vidptr;		/* virtual address */
...
__SRCVERSION( "$URL: http://svn/product/tags/public/bsp/nto641/ti-omap3530-beagle/latest/src/hardware/devg/public/graphics/display.h $ $Rev: 308279 $" )
