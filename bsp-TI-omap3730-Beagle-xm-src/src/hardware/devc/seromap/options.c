...
Options:
 ...
 -p           Flag used for omap3730 and other boards (default 0) to
              prevent rx and tx interrupts from being cleared
...
options(int argc, char *argv[]) {
	...
	while (optind < argc) {
		...
		while ((opt = getopt(argc, argv, IO_CHAR_SERIAL_OPTIONS "c:t:T:u:l:p")) != -1) {	
...
__SRCVERSION( "$URL: http://svn/product/tags/public/bsp/nto641/ti-omap3530-beagle/latest/src/hardware/devc/seromap/options.c $ $Rev: 308279 $" );
