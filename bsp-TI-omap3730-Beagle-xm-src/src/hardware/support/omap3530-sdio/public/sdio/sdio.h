...
extern int	sdio_attach_device(void *hdl, uint16_t vid, uint16_t did);
...
extern void	*sdio_init(void * (*hc_init)(void *, void *), void *cfg);

extern int	sdio_stop(void *hdl);

extern void	*sdhci_init(void *, void *);
extern void	*hbsdc_init(void *, void *);
//extern void	*omap_init(void *, void *);
extern void	*mpc5125_init(void *, void *);


#if 0
int *sdio_register(int, ...);
int sdio_read_ioreg(void *sdio_ctx, ...);
int sdio_write_iomem(void *sdio_ctx, ...);
int sdio_read_iomem(void *sdio_ctx, ...);
int sdio_write_ioreg(void *sdio_ctx, ...);
int sdio_unmask();
int sdio_free_irq(void *sdio_ctx, ...);
int sdio_enable_SDIO_INT();
int sdio_unregister(int, void *sdio_ctx);


int sdio_get_vendor_id();
int sdio_SetClockSpeed();
int sdio_SetClock();
int sdio_SetBusWidth();
int sdio_SetGPO();
