...
omap_options(omap_dev_t *dev, int argc, char *argv[])
{
    ...
    while (!done) {
        prev_optind = optind;
        c = getopt(argc, argv, "a:i:p:s:v:c:");
        switch (c) {
...
__SRCVERSION( "$URL: http://svn/product/tags/public/bsp/nto641/ti-omap3530-beagle/latest/src/hardware/i2c/omap35xx/options.c $ $Rev: 308279 $" );
