...
main (int argc, char *argv[])
{
	...
	else if (strncmp (buf, "OMAP3730", 8) == 0)
	{
		res[RSRCDBMGR_DMA_CHANNEL].type = RSRCDBMGR_DMA_CHANNEL;
		res[RSRCDBMGR_DMA_CHANNEL].start = 0;
		res[RSRCDBMGR_DMA_CHANNEL].end = 31;
...
__SRCVERSION( "$URL: http://svn/product/tags/public/bsp/nto641/ti-omap3530-beagle/latest/src/utils/r/resource_seed/main.c $ $Rev: 308279 $" );
