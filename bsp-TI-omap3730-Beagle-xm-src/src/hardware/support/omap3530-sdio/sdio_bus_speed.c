...
__SRCVERSION( "$URL: http://community.qnx.com/svn/repos/internal_core_networking/branches/6.4.1/trunk/sys/dev_nda/mv8688uap/lib/sdio/sdio_bus_speed.c $ $Rev: 252 $" );
